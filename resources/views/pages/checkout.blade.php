...
@section('title', 'Checkout | Tournoehoen')
          ...
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details">
              ...
              <div class="member mt-3">
                <h2>Add Member</h2>
                <form class="form-inline" method="get" action="{{ route('checkout-create', $item->id) }}">
                  @csrf
                ...
                <p class="disclaimer mb-0">
                  You are only invite member that has registered in
                  Tournoehoen.
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <p class="payment-instruction">
                Please complete your payment before continue to the wonderful
                trip
              </p>
              <div class="bank">
                <div class="bank-item pb-3">
                  <img
                    src="{{url('frontend/icon/ic_bank.png')}}"
                    alt="ic-bank"
                    class="bank-image"
                  />
                  <div class="description">
                    <h3>PT Tournoehoen ID</h3>
                    <p>
                      0852-5241-2312
                      <br />
                      Bank Central Asia
...
@push('addon-script')
<script src="{{url('https://unpkg.com/gijgo@1.9.13/js/gijgo.min.js')}} "type= "text/javascript" defer></script>
<script>
  $(document).ready(function () {
    $(".datepicker").datepicker({
        ...
        icons: {
        rightIcon: '<img src="{{url('frontend/icon/ic_doe.png')}}"/>',
        },
    });
  });
</script>
